...
// Auto-generated Java Swing calculator from CPJ
import javax.swing.*;
import java.awt.*;
...
public class GeneratedCalculator extends JFrame implements ActionListener {
    ...
    public void pressButton(final String label) {
        try {
            javax.swing.SwingUtilities.invokeAndWait(() -> {
                // search recursively for a JButton with matching text
                java.util.List<java.awt.Component> stack = new java.util.ArrayList<>();
                stack.add(this.getContentPane());
                while (!stack.isEmpty()) {
                    java.awt.Component c = stack.remove(stack.size() - 1);
