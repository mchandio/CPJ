...
class CPJListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CPJParser#typeFieldList.
    def enterTypeFieldList(self, ctx:CPJParser.TypeFieldListContext):
        pass

    # Exit a parse tree produced by CPJParser#typeFieldList.
    def exitTypeFieldList(self, ctx:CPJParser.TypeFieldListContext):
        pass
