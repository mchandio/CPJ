...
class TypeChecker:
    ...
    def _collect_types(self):
        # Add built-in generic types and universal type 'any'
        self.type_table['List'] = {'fields': set(), 'methods': set(), 'generics': ['T']}
        self.type_table['any'] = {'fields': set(), 'methods': set(), 'generics': []}
